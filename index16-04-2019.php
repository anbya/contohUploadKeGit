...
$namauserpos=$_SESSION['namausernahmpos'];
            ...
            <!-- /menu -->
                <div class="col-md-12 nopadding">
                    ...
                    <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="btn btn-nahm btn-block active" id="ITEM-tab" data-toggle="tab" href="#ITEM" role="tab" aria-controls="ITEM"
                            aria-selected="true" style="border-radius: 0px;border-style:solid;border-color: #300000;border-width: 1px;">TAMBAH ITEM</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-nahm btn-block" id="OPERATION-tab" data-toggle="tab" href="#OPERATION" role="tab" aria-controls="OPERATION"
                            aria-selected="false" style="border-radius: 0px;border-style:solid;border-color: #300000;border-width: 1px;">OPERATION</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="ITEM" role="tabpanel" aria-labelledby="ITEM-tab">
                            <div class="card">
                                <div class="card-body nopadding scrollpage" style="height:20vh;color:#fff;border-style:solid;border-color: #300000;border-width: 3px;">
                                    <div class="row nopadding">
                                        ...
                                        <div class="col-3 nopadding">
                                            <a href="index.php?transtempprm=<?php echo $transtempprm;?>&subcat=<?php echo $hsubcat['kdsubcategory'];?>" class="btn btn-nahm btn-block" style="color:#fff;background-color: #861919;text-decoration: none;border-radius: 0px;"><?php echo $hsubcat['nmsubcategory'];?></a>
                                        </div>
                                        <?php
                                        }
                                        ?>
                                ...
                                <div class="card-body nopadding scrollpage" style="height:30vh;border-style:solid;border-color: #300000;border-width: 3px;">
                                    <div class="row nopadding">
                                        <?php
                                        ...
                                        {
	                                        $additem=mysqli_query($koneksi,"select * from pos_item where kdsubcategory = '$_GET[subcat]'");
													...
													<div class="modal-content">
														<div class="card">
															...
															<div class="card-body justify-content-center">
                                                                ...
                                                                <div class="row" style="margin: 0px;padding: 0px;">
                                                                    <div class="col-12" style="padding: 3px;margin: 0px;">
                                                                        <select class="form-control" name="squenceorder" required>
                                                                        <option value="" disabled selected>PILIH ORDER</option>
                                                                        <?php
                                                                        $ceksquenceorder=mysqli_query($koneksi,"select * from pos_itemtemp where transtemp = '$transtempprm' order by squenceorder DESC");
	                                        							$hceksquenceorder=mysqli_fetch_array($ceksquenceorder);
	                                        							$rceksquenceorder=mysqli_num_rows($ceksquenceorder);
	                                        							if(!empty($rceksquenceorder))
		                                        						{
		                                        							$limitsqnc=$hceksquenceorder['squenceorder'];
		                                        							for($sqnc=1;$sqnc<=$limitsqnc;$sqnc++)
		                                        							{
	                                                                        ?>
	                                                                        <option value="<?php echo $sqnc; ?>">ORDER KE <?php echo $sqnc; ?></option>
	                                                                        <?php
	                                                                    	}
	                                                                    	$plusorder=$limitsqnc+1;
	                                                                    	?>
	                                                                        <option value="<?php echo $plusorder; ?>">BUAT ORDER BARU</option>
	                                                                    <?php
	                                                                    }
	                                                                    else
	                                                                    {
	                                                                    ?>
	                                                                    	<option value="1">BUAT ORDER PERTAMA</option>
	                                                                    <?php
	                                                                	}
	                                                                	?>
                                                                        </select>
																	...
																	<input type="text" name="txt1" class="form-control ml-0" placeholder="input jumlah item">
																<div class="row">
																...
																<div class="row">
																	<div class="col-12">
																		<button class="btn btn-nahm btn-block">Proses</button>
																	</div>
																</div>
																</form>
															</div>
                        ...
                        <div class="tab-pane fade" id="OPERATION" role="tabpanel" aria-labelledby="OPERATION-tab">
                                <div class="row" style="margin: 0px;padding: 0px;">
                                    ...
                                    <!--Modal: cetakorder-->
                                        <div class="modal fade" id="modalcetakorder" tabindex="-1" role="dialog" aria-labelledby="modalcetakorder" aria-hidden="true">
                                            <div class="modal-dialog cascading-modal" role="document">
                                                <!--Content-->
                                                <div class="modal-content">
									                <div class="card">
                                    ...
                                    <td colspan="3">
                                    <input type="hidden" name="notrans" value="<?php echo $transtempprm;?>" class="form-control ml-0">
                                    <input type="text" name="txt1" class="form-control ml-0" value="">
                                    </td>
                                    </tr>
                                    <tr>
                                    ...
                                    while($hpromotionprm = mysqli_fetch_array($promotionprm)) 
                                    {
	                                    ...
	                                    if ($cekdatec>=$cekdatea AND $cekdatec<=$cekdateb)
		                                    ...
		                                    $countprmtestdays=array_search($testdays,$xtestdays);
		                                    if($countprmtestdays>0)
		                                    	...
		                                    	{
		                                    	echo $cektimea."=".$cektimeb."=".$cektimec."=".$testdays;
		                                    	}
		                                    }
	                                    else
	                                    	{
