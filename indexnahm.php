        ...
        <!-- /menu -->
            <div class="col-md-12 tepian">
                ...
                ?>
                                        ...
                                        <div class="tab-pane fade in show active" id="panel171" role="tabpanel">
                                            ...
                                            <div class="modal-body text-center mb-1">
                                                ...
                                                <table width="65%" align="center">
                                                    ...
                                                    <input type="text" name="txt1" class="form-control ml-0" placeholder="masukan ID Member" value="NHM">
                                                    </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="tab-pane fade" id="panel172" role="tabpanel">
                                            ...
                                            <div class="modal-body text-center mb-1">
                                                ...
                                                <table width="65%" align="center">
                                                    ...
                                                    <td colspan="3">
                                                    <input type="hidden" name="notrans" value="<?php echo $_SESSION['iduser'];?>" class="form-control ml-0">
                                                    <input type="text" name="txt1" class="form-control ml-0" placeholder="masukan ID Member" value="">
                                                    </td>
                                                    </tr>
                                                    <tr>
                    ...
                    <div class="col-md-12">
                    <a href="#" class="btn btn-nahm btn-block maxwidthheight" onclick="paymentalert()">PAYMENT</a>
                    </div>
                    <?php
                    }
                    else
                                        ...
                                        <div class="tab-pane fade" id="panel19" role="tabpanel">
                                            ...
                                            <div class="modal-body text-center mb-1">
                                                ...
                                                <table width="65%" align="center">
                                                    ...
                                                    <td colspan="3">
                                                    <input type="hidden" name="notrans" value="<?php echo $_SESSION['iduser'];?>" class="form-control ml-0">
                                                    <input type="hidden" name="grandtotal" value="<?php echo $finalgt;?>" class="form-control ml-0">
                    ...
                    <div class="col-md-12">
                    <a href="#" class="btn btn-nahm btn-block maxwidthheight" onclick="tutuptransaksi1()">TUTUP TRANSAKSI</a>
                    </div>
                    <?php
                    }
                    elseif($finalgt > $jb)
                    ...
                    else
                    {
                        ?>
                        <div class="col-md-12">
                        <a href="savetransaction.php?usr=<?php echo $usrpay;?>&date=<?php echo $datepay;?>&time=<?php echo $timepay;?>&outlet=<?php echo $outletpay;?>&gt=<?php echo $gt;?>&gttax=<?php echo $gttax;?>&finalgt=<?php echo $finalgt;?>" class="btn btn-nahm btn-block maxwidthheight">TUTUP TRANSAKSI</a>
                        </div>
                    <?php
                    }
                    ?>
                    ...
                    <!--Modal: void-->
                    <div class="col-md-12">
                    <a href="ptscu/nahm/index.php" class="btn btn-nahm btn-block maxwidthheight" onclick="menukanan1()">CRM</a>
                    </div>
                    <div class="col-md-12">
                    <a href="#" class="btn btn-nahm btn-block maxwidthheight" data-toggle="modal" data-target="#modalredeem">REDEEM</a>
                    </div>
                    <!--Modal: redeem-->
