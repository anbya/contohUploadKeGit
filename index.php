...
<?php }
    ...
    <div class="row mh2">
            ...
            <div class="row mh2" style="background-color: #8c0000;padding: 2vh;">
                <div class="col-md-12 tepian" style="background-color: #ffffff;">
                    ...
                    <div class="row mh50 scrollpage" style="background-color: #ffffff;">
                        ...
                        <?php
                        include "koneksi.php";
                        $itemtemp=mysqli_query($koneksi,"SELECT * FROM pos_itemtemp where transtemp ='$transtempprm' AND bill = '$prmbill' AND squenceorder != 'tmp' group by additional, kditem");
                        while($hitemtemp = mysqli_fetch_array($itemtemp))
                            {
                            ?>
                            <?php
                            $kditem=$hitemtemp['kditem'];
                            $additional=$hitemtemp['additional'];
                            $itemdet=mysqli_query($koneksi,"SELECT * FROM pos_item where kditem = $kditem");
                            $hitemdet = mysqli_fetch_array($itemdet);
                            $sumsubtotalitem=mysqli_query($koneksi,"SELECT SUM(price) AS sumsubtotal FROM pos_itemtemp where kditem = '$kditem' AND additional ='$additional' AND transtemp ='$transtempprm' AND bill = '$prmbill' ");
                            $hsumsubtotalitem = mysqli_fetch_array($sumsubtotalitem);
                            $sumqtyitem=mysqli_query($koneksi,"SELECT SUM(qty) AS sumsqty FROM pos_itemtemp where kditem = '$kditem' AND additional ='$additional' AND transtemp ='$transtempprm' AND bill = '$prmbill'  ");
                            ...
                            <div class="row">
                            <div class="col-6 d-flex justify-content-left align-items-center">
                                <a><?php echo $hitemdet['nmitem']." ".$tampiladd;?></a>
                            </div>
                            <div class="col-2 d-flex justify-content-left align-items-center">
                                <a><?php echo $hsumqtyitem['sumsqty'];?></a>
                            </div>
                            <div class="col-4 d-flex justify-content-left align-items-center">
                                <a><?php echo number_format("$hsumsubtotalitem[sumsubtotal]");?></a>
                            </div>
                            </div>
                            <?php
                            }
                    ...
                    <div class="row mh25 scrollpage" style="background-color: #ffffff;border-top: solid;">
                        ...
                        $querytotalbill = "SELECT SUM(price) AS grand_total, SUM(qty) AS grand_qtybill FROM pos_itemtemp WHERE transtemp = '$transtemp' AND bill = '$prmbill' AND squenceorder != 'tmp' ";
                        ...
                        $totalqtyperbill=$hresultquerytotalbill['grand_qtybill'];
                        ?>
                            <div class="row">
                                <div class="col-7">
                            ...
                            <?php
                            $addpayprm=mysqli_query($koneksi,"SELECT * FROM pos_parameter");
                        	$haddpayprm = mysqli_fetch_array($addpayprm);
                        	if($haddpayprm['service_charge']>0)
                        	{
                            $servicecharge=floor($subtotalbill*$haddpayprm['service_charge']/100);
                            $subbillsvc=$subtotalbill+$servicecharge;
                            $taxbill=ceil($subbillsvc*$haddpayprm['tax']/100);
                            ?>
                            <div class="row">
                                <div class="col-7">
                        	...
                        	?>
                            <?php
                            $xgrandtotalbill=$subtotalbill+$taxbill+$servicecharge;
                            $grandtotalbill=ceil($xgrandtotalbill);
                            ?>
                            <div class="row">
                                <div class="col-7">
        ...
        <div class="col-md-7">
            <div class="row">
				...
				<?php
                                if(!empty($payment)){
                                $sisapembayaran=$grandtotalbill-$tampilpayment;
                                if($sisapembayaran<=0)
                                {
                                    $tampilsisabayar=0;
                                }
                                ...
                                {
                                    $tampilsisabayar=$sisapembayaran;
                                }
                                ?>
                                <div class="row">
                                    <div class="col-6">
                                        <a style="font-size: 2.5vh;"><b>Sisa Bayar</b></a>
                                    </div>
                                    <div class="col-1" style="border-bottom: solid;">
                                        <a style="font-size: 2.5vh;"><b>:</b></a>
                                    </div>
                                    <div class="col-5" style="text-align: right;border-bottom: solid;">
                                        <a style="font-size: 2.5vh;"><b>Rp. <?php echo number_format("$tampilsisabayar");?></b></a>
                                    </div>
                                </div>
                                <?php
                                }
                                                ...
                                                <div class="modal-body text-center mb-1">
                                                    <div class="card">
                                                        <form action="saveorder.php" method="post">
                                                            <div class="card-body">
                                                                <div class="row mh1 scrollpage" style="margin: 0px;padding: 0px;">
                                            ...
                                            <a href="#" class="btn btn-nahm btn-block maxwidthheight" data-toggle="modal" data-target="#modalbukatans" style="padding-left: 0px;padding-right: 0px;">BUKA TRANSAKSI</a>
                                                ...
                                                <div class="tab-pane fade in show active" id="panelbukatransdinein" role="tabpanel">
	                                                ...
	                                                <div class="modal-body scrollpage mh3 mb-1">
		                                                ...
		                                                <div class="row nopadding" id="tampillistopentrans">
		                                                </div>
	                                                </div>
	                                                <!--Body-->
                                                </div>
	                    ...
	                    <div class="card" style="background-color: #ffffff;">
	                        ...
	                        <div class="card-body" style="padding: 0px;">
	                            <div class="row" style="margin: 0px;padding: 0px;">
	                                                        ...
	                                                        <div class="tab-content">
	                                                            ...
	                                                            <div class="tab-pane fade in show active" id="panel171" role="tabpanel">
	                                                                ...
	                                                                <div class="modal-body mb-1">
	                                                                    ...
	                                                                    <?php
	                                                                    include "koneksi.php";
	                                                                    $sqlplu=mysqli_query($koneksi,"SELECT * FROM pos_itemtemp where transtemp = '$transtemp' group by additional, kditem");
	                                                                    while($hsqlplu = mysqli_fetch_array($sqlplu))
	                                                                    {
	                                                                    $qtycek=$hsqlplu['kditem'];
                                                                        $additional2=$hsqlplu['additional'];
                                                                        $voidsqnc=$hsqlplu['squence'];
                                                                        $voidminplus=$hsqlplu['kditem'].$hsqlplu['additional'];
	                                                                    ...
	                                                                    $sumqtyitemvoid=mysqli_query($koneksi,"SELECT SUM(qty) AS sumsqty FROM pos_itemtemp where kditem = '$qtycek' AND additional ='$additional2' AND transtemp ='$transtempprm' ");
	                                                                    $hsumqtyitemvoid = mysqli_fetch_array($sumqtyitemvoid);
	                                                                    $maxqtyvoid=$hsumqtyitemvoid['sumsqty'];$additional=$hparam1['additional'];
                                                                        if($additional2==$qtycek)
                                                                        {
                                                                            $tampiladd="";
                                                                        }
                                                                        else
                                                                        {
                                                                            $tampiladd=$additional2;
                                                                        }
	                                                                    ?>
	                                                                    <div class="row" style="margin: 0px;padding: 0px;">
	                                                                        <div class="col-8" style="padding: 3px;margin: 0px;"><strong><?php echo $hresultfetchitem['nmitem']."</br>".$tampiladd;?> (<?php echo $maxqtyvoid;?>)</strong></div>
	                                                                        <div class="col-4" style="padding: 3px;margin: 0px;">
	                                                                        	<button type="button" onclick="min(<?php echo $qtycek.$voidsqnc;?>)"><b>-</b></button>
																				<input type="text" id="<?php echo $qtycek.$voidsqnc;?>" name ="<?php echo $voidminplus;?>" value="0" style="width: 40%;text-align:center;">
																				<button type="button" onclick="plus(<?php echo $qtycek.$voidsqnc;?>,<?php echo $maxqtyvoid;?>)"><b>+</b></button>
	                                                                        </div>
	                                                                    </div>
	                                                                    <?php
	                                                                    }
                                        ...
                                        <!--Modal: remarks-->
                                        <div class="col-md-3 nopadding">
                                        <a href="#" class="btn btn-nahm btn-block maxwidthheight" data-toggle="modal" data-target="#modalremarks" style="padding-left: 0px;padding-right: 0px;">REMARKS</a>
                                        </div>
                                            <div class="modal fade" id="modalremarks" tabindex="-1" role="dialog" aria-labelledby="modalremarks" aria-hidden="true">
                                                <div class="modal-dialog cascading-modal" role="document">
                                                    <!--Content-->
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-c-tabs">
                                                            ...
                                                            <ul class="nav nav-tabs tabs-2" role="tablist">
                                                                <li class="nav-item">
                                                                    <a class="btn btn-nahm btn-block" data-toggle="tab" href="#panel171" role="tab">REMARKS</a>
                                                                </li>
                                                            </ul>

                                                            <!-- Tab panels -->
                                                            <form action="simpanremarks.php" method="post">
                                                            <div class="tab-content">
                                                                <!--Panel 17-->
                                                                <div class="tab-pane fade in show active" id="panel171" role="tabpanel">
                                                                    ...
                                                                    <!--Body-->
                                                                    <div class="modal-body mb-1">
                                                                        <input type="hidden" name ="prmremarks" value="<?php echo $transtempprm;?>" style="width: 100%;">
                                                                        <div class="form-group">
                                                                            <label for="comment">ISI REMARKS DI BAWAH :</label>
                                                                            <textarea class="form-control" rows="5" id="comment" name="remarks"></textarea>
                                                                        </div>
                                                                        <div class="row" style="margin: 0px;padding: 0px;">
                                                                            <div class="col-12" style="padding: 3px;margin: 0px;"><button class="btn btn-nahm btn-block" type="submit" id="btnputorder">SIMPAN REMARKS</button></div>
                                                                        </div>
                                                                        <div class="row" style="margin: 0px;padding: 0px;">
                                                                            <div class="col-12" style="padding: 3px;margin: 0px;"><a class="btn btn-nahm btn-block" role="button" href="index.php?transtempprm=<?php echo $transtempprm;?>" id="btnvoidorder">BATAL</a></div>
                                                                        </div>
                                                                    ...
                                                                    <div class="modal-body mb-1">
                                                                        ...
                                                                        <div class="row" style="margin: 0px;padding: 0px;">
                                                                            <div class="col-12" style="padding: 3px;margin: 0px;">
                                                                                ...
                                                                                <?php
                                                                                include "koneksi.php";
                                                                                $postemp=mysqli_query($koneksi,"SELECT * FROM pos_salestemp where status = 'OPEN' AND notrans != '$transtempprm'");
                                                                                while($hpostemp = mysqli_fetch_array($postemp))
                                                                                {
                                                                                $opentrans=$hpostemp['notrans'];
                                                                                $tabletrans=$hpostemp['meja'];
	                                    ...
	                                    <td colspan="3">
	                                    <input type="hidden" name="notrans" value="<?php echo $transtempprm;?>" class="form-control ml-0">
	                                    <input type="text" name="txt1" class="form-control ml-0" value="" placeholder="SCAN KARTU MEMBER">
	                                    </td>
	                                    </tr>
	                                    <tr>
	                                    ...
	                                    <td colspan="2"><input type=button name="btnnhmcash" value=NHM onclick="displynummbr(btnnhmcash.value)" class="btn btn-nahm btn-block"></td>
	                                    </tr>
	                                    <tr>
	                                    ...
	                                    -->
	                                    <div class="col-md-3 nopadding">
	                                    <a href="escpos/cetakopenbill.php?keytrans=<?php echo $transtempprm;?>" class="btn btn-nahm btn-block maxwidthheight" style="padding-left: 0px;padding-right: 0px;">CETAK OPEN BILL</a>
	                                    </div>
	                                    <?php
	                                    if($totalqtyperbill == 0)
	                                    {
                					    ...
                					    <option value="EMONEY_MANDIRI">EMONEY MANDIRI</option>
                					    <option value="POTONGAN_GRABKITCHEN">POTONGAN GRABKITCHEN</option>
	                                    </select>
	                                    ...
	                                    <input type="text" name="num" value="" class="form-control ml-0" placeholder="INPUT NOMOR KARTU">
	                                    <select class="form-control" name="jnscard" required>
	                                    ...
	                                    ?>
	                                    <div class="col-md-3">
	                                    <a href="addotherpayment.php?transtempprm=<?php echo $transtempprm;?>&jnspay=<?php echo $namaotherpay;?>&jml=<?php echo $jumlahotherpay;?>&lastuser=<?php echo $_SESSION['iduser'];?>&lastmodify=<?php echo "".date("Y-m-d", $tanggal)."";?>&bill=<?php echo $prmbill;?>&idterminal=<?php echo $idterminal;?>" class="btn btn-nahm btn-block"><?php echo $namaotherpay;?></a>
	                                    </div>
	                                    <?php
	                                    }
	                                    ?>
	                                    ...
	                                    <!--Modal: other payment-->
	                                    <div class="col-md-3 nopadding">
	                                    <a href="hapuspospaymenttemp.php?transtempprm=<?php echo $transtempprm;?>&bill=<?php echo $prmbill;?>" class="btn btn-nahm btn-block">VOID PEMBAYARAN</a>
	                                    </div>
	                                    <!--Modal: void payment-->
	                    ...
	                    <div class="card" style="background-color: #ffffff;color: #fff;">
	                        ...
	                        <div class="card-body" style="padding: 0px;">
	                            <div class="row" style="margin: 0px;padding: 0px;">
														...
														<div class="card-body scrollpageall" style="background-color: #ffffff;color: #000;" onkeypress="return">
															<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
											                  ...
											                  <tbody>
											                    ...
											                    ?>
											                    <tr>
											                      <td><a href="tampilrekap.php?transtempprm=<?php echo $json[$x]['notrans'];?>" class="btn btn-nahm btn-block maxwidthheight" style="padding-left: 0px;padding-right: 0px;color: #fff;">BUKA TRANSAKSI</a></td>
                                                                  ...
                                                                  <td class="align-middle"><?php echo substr($json[$x]['member'],14);?></td>
											                    </tr>
											                    <?php
											                    }
											                    ?>
									...
									<!--Modal: sales summary-->
                                    <div class="col-md-3 nopadding">
                                    <a href="#" class="btn btn-nahm btn-block maxwidthheight" data-toggle="modal" data-target="#modalitem" style="padding-left: 0px;padding-right: 0px;">ITEM LIST</a>
                                    </div>
                                    <!--Modal: ITEM LIST-->
                                    <div class="modal fade active" id="modalitem" tabindex="-1" role="dialog" aria-labelledby="modalitem" aria-hidden="true">
                                        <div class="modal-dialog modal-fluid" role="document">
                                            <!--Content-->
                                                <div class="modal-content">
                                                <!--Header-->
                                                <div class="modal-header" style="background-color: #6c0000;">
                                                  <p class="heading lead">ITEM LIST</p>
                                                ...
                                                <div class="modal-body">
                                                    <div class="card">
                                                        <div class="card-body scrollpageall" style="background-color: #ffffff;color: #000;" onkeypress="return">
                                                            <table id="dtitemlist" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                              <thead>
                                                                <tr>
                                                                  <th class="th-sm">KATEGORY
                                                                  </th>
                                                                  <th class="th-sm">SUB KATEGORY
                                                                  </th>
                                                                  <th class="th-sm">NAMA ITEM
                                                                  </th>
                                                                  <th class="th-sm">HARGA ITEM
                                                                  </th>
                                                                  <th class="th-sm">STATUS ITEM
                                                                  </th>
                                                                </tr>
                                                              </thead>
                                                              <tbody>
                                                                <?php
                                                                include "koneksi.php";
                                                                $itemlist=mysqli_query($koneksi,"SELECT * FROM pos_item");
                                                                while($hitemlist = mysqli_fetch_array($itemlist))
                                                                {
                                                                $keylistkat=$hitemlist['kdcategory'];
                                                                $keylistsubkat=$hitemlist['kdsubcategory'];
                                                                $itemlistkat=mysqli_query($koneksi,"SELECT * FROM pos_kategoryitem where kdcategory='$keylistkat'");
                                                                $hitemlistkat = mysqli_fetch_array($itemlistkat);
                                                                $itemlistsubkat=mysqli_query($koneksi,"SELECT * FROM pos_subcategory where kdsubcategory='$keylistsubkat'");
                                                                $hitemlistsubkat = mysqli_fetch_array($itemlistsubkat);
                                                                ?>
                                                                <tr>
                                                                  <td class="align-middle"><?php echo $hitemlistkat['nmcategory'];?></td>
                                                                  <td class="align-middle"><?php echo $hitemlistsubkat['nmsubcategory'];?></td>
                                                                  <td class="align-middle"><?php echo $hitemlist['nmitem'];?></td>
                                                                  <td class="align-middle"><?php echo number_format($hitemlist['price']);?></td>
                                                                  <td class="align-middle"><?php echo $hitemlist['state'];?></td>
                                                                </tr>
                                                                <?php
                                                                }
                                                                ?>
	                                            ...
	                                            <div class="modal-content">
										            <div class="card">
										                ...
										                <div class="card-body" style="background-color: #ffffff;color: #000;">
															...
															{
															$keydiscitemket=$hdiscitemdet['id_promotion'];
															$discitemket=mysqli_query($koneksi,"SELECT * FROM promotion_h WHERE id_promotion = '$keydiscitemket'");
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <p style="margin-top: 5px;margin-bottom: 1px;text-align: left;">
                                                                    Dept:<?php echo $hdetbvgdept['nmsubcategory'];?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-8">
                                                                    <p style="margin-top: 5px;margin-bottom: 1px;text-align: left;">
                                                                    <?php echo $hdetbvgdeptitem['nmitem'];?>
                                                                    </p>
                                                                </div>
                                                                <div class="col-4">
                                                                    <p style="margin-top: 1px;margin-bottom: 5px;text-align: right;">
                                                                    <?php echo $hsumdetbvgdeptitem['qtydeptitem'];?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <?php
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4">
                                                                    <p style="margin-top: 1px;margin-bottom: 5px;text-align: right;">
                                                                    <?php echo $hsumdetbvgdept['qtydept'];?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4">
                                                                    <p style="margin-top: 1px;margin-bottom: 5px;text-align: right;">
                                                                    <?php echo $hsumbeverages['qtybeverages'];?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="row">
										                	...
										                	<div class="row" style="padding-top: 15px;padding-bottom: 15px;">
	                            								...
	                            								<a href="escpos/cetaksalessummary.php?idterminal=<?php echo $idterminal;?>&user=<?php echo $usrpay;?>" class="btn btn-nahm btn-block" style="color:#fff;background-color: #861919;text-decoration: none;border-radius: 0px;">PRINT SALES SUMMARY</a>
										                		</div>
										                	</div>
										                </div>
										            </div>
	                                ...
	                                <!--Modal: sales summary-->
	                                <div class="col-md-3 nopadding">
	                                <a href="keluar.php" class="btn btn-nahm btn-block maxwidthheight" style="padding-left: 0px;padding-right: 0px;" onclick="return confirm('ANDA YAKIN AKAN LOGOUT ?')">LOGOUT</a>
	                                </div>
	                                <div class="col-md-3 nopadding">
	                                <a href="escpos/cekclosing.php?user=<?php echo $usrpay;?>&idterminal=<?php echo $idterminal;?>" class="btn btn-nahm btn-block maxwidthheight" style="padding-left: 0px;padding-right: 0px;" onclick="return confirm('ANDA YAKIN AKAN MENUTUP TERMINAL POS INI ?')">CLOSING DAY KASIR</a>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
    ...
    <script>
        ...
        setInterval(function(){
            $.ajax({
            url: 'tampillistopentrans.php',
            type: 'get',
            data: {
                test: "<?php echo $idterminal;?>",
            },
            success: function(html){
                $('#tampillistopentrans').html(html);
            }
        });
        }, 1000);
        });
