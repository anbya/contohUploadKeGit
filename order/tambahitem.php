...
<head>
    ...
    .mh1
        {
          height: 44vh; /* 30% of viewport height*/
          max-height: 44vh;
        }
    .mh1-4
        {
    ...
    .mhnew
        {
          height: 68vh; /* 30% of viewport height*/
          max-height: 68vh;
        }
    .mh25
        {
...
<?php }
    ...
    <div class="row mh2" style="background-color: #8c0000;">
        <div class="col-12">
        <ul class="nav nav-tabs tabs-2" id="myTab" role="tablist">
            <li class="nav-item" style="width: 50%;">
                <a class="btn btn-nahm btn-block active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
                  aria-selected="true">MENU ORDER</a>
            </li>
            <li class="nav-item" style="width: 50%;">
                <a class="btn btn-nahm btn-block" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="col-12">
                    <div class="row mh1 scrollpage" style="background-color: #ffffff;">
                        <div class="col-12 col-md-12 tepian">
                            <div class="row nopadding">
                                ...
                                <div class="col-12 col-md-3 nopadding">
                                    <a href="tambahitem.php?transtempprm=<?php echo $transtempprm;?>&subcat=<?php echo $hsubcat['kdsubcategory'];?>" class="btn btn-nahm btn-block" style="color:#fff;background-color: #b64949;text-decoration: none;border-radius: 0px;"><?php echo $hsubcat['nmsubcategory'];?></a>
                                </div>
                                <?php
                                }
                                ?>
                                        ...
                                        <div class="modal-content">
                                            <div class="card">
                                                ...
                                                <div class="card-body justify-content-center">
                                                    ...
                                                    <form name="calcform<?php echo $keyadditem;?>" action="buatorderproses.php" method="post">
                            ...
                            <div class="row mhnew scrollpage" style="background-color: #ffffff;">
                                ...
                                while($hitemtemp = mysqli_fetch_array($itemtemp)) 
                                    ...
                                    <div class="col-2 nopadding">
                                        <a href="voidbuatorder.php?prmvoid=<?php echo $transtempprm;?>&kditemvoid=<?php echo $kditem;?>&subcat=<?php echo $_GET['subcat'];?>" class="btn btn-nahm btn-block" style="color: #fff;">
