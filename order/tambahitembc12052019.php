                    ...
                    <div class="row mhnew scrollpage" style="background-color: #ffffff;">
                        ...
                        while($hitemtemp = mysqli_fetch_array($itemtemp)) 
                            ...
                            <div class="col-2 nopadding">
                                <a href="voidbuatorder.php?prmvoid=<?php echo $transtempprm;?>&kditemvoid=<?php echo $kditem;?>" class="btn btn-nahm btn-block" style="color: #fff;">
                                ...
                                <div class="modal-content">
                                    <div class="card">
                                        ...
                                        <div class="card-body justify-content-center">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <input type="text" name="note" class="form-control ml-0" placeholder="Note Lain-Lain">
                                                </div>
                                            </div>
                                            <div class="row">
