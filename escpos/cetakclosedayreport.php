...
/*sumdiscitem*/
$sumbildisc=mysqli_query($koneksi,"SELECT sum(qty) as sumqtybildisc, sum(disc) as sumdiscbil FROM pos_promotion_d where terminal_id = '$idterminal' and promotion_type = 'DISC ALL' and paid_status = 'PAID'");
$hsumbildisc = mysqli_fetch_array($sumbildisc);
/*sumdiscitem*/
$str11="BillDiscount";
$str12="(-)";
$str13=number_format($hsumbildisc['sumqtybildisc']);
$str14=number_format($hsumbildisc['sumdiscbil']);
$headertext11= str_pad($str11,20," ");
$headertext12= str_pad($str12,4," ",STR_PAD_RIGHT);
$headertext13= str_pad($str13,4," ",STR_PAD_RIGHT);
$headertext14= str_pad($str14,14," ",STR_PAD_LEFT);
