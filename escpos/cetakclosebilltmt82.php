...
$connector = new NetworkPrintConnector("192.168.0.234", 9100);
...
$headertext1= str_pad($str1,24," ");
$headertext2= str_pad($str2,24," ",STR_PAD_LEFT);
$printer -> text($headertext1.$headertext2."\n");
$str3="POS Title:".$hparam3['previlage'];
$str4="POS:".$hparamx['id_parameter'];
$headertext3= str_pad($str3,24," ");
$headertext4= str_pad($str4,24," ",STR_PAD_LEFT);
$printer -> text($headertext3.$headertext4."\n");
$str5="Rcpt#:".$billid;
$str6=$opndate." ".$opntime;
$headertext5= str_pad($str5,24," ");
$headertext6= str_pad($str6,24," ",STR_PAD_LEFT);
$printer -> text($headertext5.$headertext6."\n");
$separator= str_pad("-",48,"-");
...
$headeritem1= str_pad($stritem1,24," ");
$headeritem2= str_pad($stritem2,24," ",STR_PAD_LEFT);
...
$headertotbilla= str_pad($strtotbilla,24," ");
$headertotbillb= str_pad($strtotbillb,24," ",STR_PAD_LEFT);
...
$headerstrdisc1= str_pad($strdisc1,24," ");
$headerstrdisc2= str_pad($strdisc2,24," ",STR_PAD_LEFT);
...
$headersubtot1= str_pad($strsubtot1,24," ");
$headersubtot2= str_pad($strsubtot2,24," ",STR_PAD_LEFT);
...
$headersvch1= str_pad($strsvch1,24," ");
$headersvch2= str_pad($strsvch2,24," ",STR_PAD_LEFT);
$printer -> text($headersvch1.$headersvch2."\n");
$strtax1="TAX 10%";
$strtax2=number_format($tax);
$headertax1= str_pad($strtax1,24," ");
$headertax2= str_pad($strtax2,24," ",STR_PAD_LEFT);
...
$headergt2= str_pad($strgt2,14," ",STR_PAD_LEFT);
...
$headerdetbill1= str_pad($strdetbill1,24," ");
$headerdetbill2= str_pad($strdetbill2,24," ",STR_PAD_LEFT);
...
$headerpay1= str_pad($strpay1,24," ");
$headerpay2= str_pad($strpay2,24," ",STR_PAD_LEFT);
...
$headerchange1= str_pad($strchange1,24," ");
$headerchange2= str_pad($strchange2,24," ",STR_PAD_LEFT);
...
$headermember1= str_pad($strmember1,24," ");
$headermember2= str_pad($strmember2,24," ",STR_PAD_LEFT);
