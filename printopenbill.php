...
<div class="separator"></div>
<div class="separator"></div>
<a style="font-size: 5vh;"><b>OPEN Bill</b></a><br>
<a style="font-size: 5vh;"><b><?php echo $nowdate;?></b></a><br>
<div class="separator"></div>
<div class="separator"></div>
...
function doPrint() {
    window.print();            
    document.location.href = "index.php?transtempprm=<?php echo $transtempprm;?>";
}
</script>
</body>
</html>
