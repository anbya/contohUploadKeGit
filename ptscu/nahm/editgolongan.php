    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        date_default_timezone_set('Asia/Jakarta');
          ...
          $gapok=$_POST["input3"];
              $sql="UPDATE golongan SET golongan = '$golongan', nama_golongan = '$namagol', gaji_pokok = '$gapok'WHERE id_gol = '$idgol'";
          ...
          <?php
                $idgol=$_GET['ID'];
                $gol=mysql_query("SELECT * FROM golongan where id_gol = '$idgol'");
          ...
          <form action="" enctype="multipart/form-data" class="formoid-solid-dark" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
                        ...
                        <input type="hidden" name="inputx" value="<?php echo $hgol['id_gol'];?>" class="form-control" required>
                        
                        <div class="form-group">
                            <label class="col-lg-6 control-label">GOLONGAN</label>
                            <div class="col-lg-7">
                                <input type="hidden" name="input1" value="<?php echo $hgol['golongan'];?>" class="form-control" required>
                                <input type="text" name="inputqaz" value="<?php echo $hgol['golongan'];?>" class="form-control" disabled>
                                <strong></strong>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="hidden" name="input2" value="<?php echo $hgol['nama_golongan'];?>" class="form-control" required>
                                <input type="text" name="inputqaz" value="<?php echo $hgol['nama_golongan'];?>" class="form-control" disabled>
                                <strong></strong>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" name="input3" value="<?php echo $hgol['gaji_pokok'];?>" class="form-control" required>
                                <strong></strong>
                            </div>
                        </div>
                        <div class="form-group">
