  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        $idmember=$_GET["ID"];
        $kartu=$_GET["kartu"];
        $member=mysql_query("SELECT * FROM member WHERE id_member = '$idmember'");
        $hmember = mysql_fetch_array($member);
        $id_member=$hmember['id_member'];
        ?>
              ...
              <div class="form-group">
                <label class="col-lg-6 control-label">MEMBER DENGAN ID</label>
                <div class="col-lg-12">
                <h2><?php echo $id_member;?></h2>
                </div>
                <label class="col-lg-12 control-label">TELAH BERHASIL DIAKTIVASI DENGAN NOMOR KARTU <b><?php echo $kartu;?></b></label>
              </div>
              <div class="form-group">
              <label class="col-lg-4 control-label"></label>
              <div class="col-lg-5">
                <a href="aktivasimember.php" class="btn btn-block btn-primary">KEMBALI</a><br>
              </div>
              </div>
          </form>
          </div>
