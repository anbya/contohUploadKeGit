    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        date_default_timezone_set('Asia/Jakarta');
          ...
          ?>
          <form action="addmember.php" enctype="multipart/form-data" class="formoid-solid-dark" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
                        ...
                        <div class="form-group">
                            <label class="col-lg-6 control-label">REFERRAL MEMBER</label>
                            <div class="col-lg-7">
                                <input type="text" name="input4" value="" class="form-control">
                                <strong></strong>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-6 control-label">CARD NUMBER</label>
                            <div class="col-lg-7">
