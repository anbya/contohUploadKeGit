    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        ?>
          ...
          <br>
          <div class="table-responsive">
          <form action="slipcetak.php" method="post" enctype="multipart/form-data" class="formoid-solid-dark" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
                        
                        <input type="hidden" name="inputx" value="<?php echo $nomat;?>" class="form-control" required>
                        
                        <div class="form-group">
                            <label class="col-lg-6 control-label">INPUT TANGGAL AWAL</label>
                            <div class="col-lg-7">
                        ...
                        <div class="form-group">
                            <label class="col-lg-6 control-label">INPUT TANGGAL AKHIR</label>
                            <div class="col-lg-7">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-7">
                            <button class="btn btn-block btn-primary" type="submit" name='submit' value="Submit">GENERATE PAYROLL</button>
                          </div>
                        </div>
          </form>
          </div>
