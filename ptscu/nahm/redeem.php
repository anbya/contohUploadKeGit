      ...
      <div class="card mb-3">
        ...
        date_default_timezone_set('Asia/Jakarta');
          ?>
                                                ...
                                                {
                                                    calcformmbr.input1.value="NHV";
                                                }
                                                </script>
          <form name="calcformmbr" action="prosesredeem.php" enctype="multipart/form-data" class="formoid-solid-dark" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
                                                <table width="65%" align="center">
                                                    <tr>
                                                        <td colspan="3" align="center"><h5>INPUT NOMOR VOUCHER ATAU SCAN VOUCHER</h5></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3"><input type="hidden" name="inputx" value="<?php echo $outlet;?>" class="form-control">
                                <input type="text" name="input1" value="NHV" class="form-control" required autofocus></td>
                                                    </tr>
                                                    <tr>
