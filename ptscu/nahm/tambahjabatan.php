    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        date_default_timezone_set('Asia/Jakarta');
          ...
          $namjab=$_POST["input2"];
          $insjab=$_POST["input3"];
              $sql="INSERT INTO jabatan values('$idgol','$unit','$namjab','$insjab')";
          ...
          ?>
          <?php 
          $idgol=mysql_query("SELECT * FROM jabatan ORDER BY id_jabatan desc");
          $hidgol = mysql_fetch_array($idgol);
          $nomatx1=substr($hidgol['id_jabatan'],1);
          ...
          <form action="" enctype="multipart/form-data" class="formoid-solid-dark" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                            ...
                                            <?php
                                            $unt=mysql_query("SELECT * FROM unit");
                                            while($hunt = mysql_fetch_array($unt)) 
                                            {
                                            ?>
                                                <option value="<?php echo $hunt['unit'];?>"><?php echo $hunt['unit'];?></option>
                                            <?php
                                            }
                                            ?>
                                            </select>
