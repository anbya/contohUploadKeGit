    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        date_default_timezone_set('Asia/Jakarta');
          ...
          $email=$_POST["input3"];
              $sql="UPDATE member SET nama_member = '$nama', telepon = '$telepon', email = '$email' WHERE id_member = '$idmember'";
          ...
          <?php
                $idgol=$_GET['ID'];
                $gol=mysql_query("SELECT * FROM member where id_member = '$idgol'");
          ...
          <form action="" enctype="multipart/form-data" class="formoid-solid-dark" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
                        ...
                        <input type="hidden" name="inputx" value="<?php echo $hgol['id_member'];?>" class="form-control" required>
                        
                        <div class="form-group">
                            <label class="col-lg-6 control-label">NAMA MEMBER</label>
                            <div class="col-lg-7">
                                <input type="hidden" name="input1" value="<?php echo $hgol['nama_member'];?>" class="form-control" required>
                                <input type="text" name="inputqaz" value="<?php echo $hgol['nama_member'];?>" class="form-control" disabled>
                                <strong></strong>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-6 control-label">NOMOR TELEPON</label>
                            <div class="col-lg-7">
                                <input type="text" name="input2" value="<?php echo $hgol['telepon'];?>" class="form-control" required>
                                <strong></strong>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" name="input3" value="<?php echo $hgol['email'];?>" class="form-control" required>
                                <strong></strong>
                            </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-lg-5">
                            ...
                            <a href="member.php" class="btn btn-block btn-danger">BATAL</a>
                          </div>
                        </div>
          </form>
