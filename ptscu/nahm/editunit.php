      ...
      <div class="card mb-3">
        ...
        date_default_timezone_set('Asia/Jakarta');
          ...
          $golongan=$_POST["input1"];
              $sql="UPDATE unit SET unit = '$golongan' WHERE id_unit = '$idgol'";
          ...
          <?php
                $idgol=$_GET['ID'];
                $gol=mysql_query("SELECT * FROM UNIT where id_unit = '$idgol'");
          ...
          <form action="" enctype="multipart/form-data" class="formoid-solid-dark" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
                        ...
                        <div class="form-group">
                            <label class="col-lg-6 control-label">NAMA UNIT</label>
                            <div class="col-lg-7">
                                <input type="text" name="input1" value="<?php echo $hgol['unit'];?>" class="form-control" required>
                                <strong></strong>
                            </div>
                        </div>
                        <div class="form-group">
