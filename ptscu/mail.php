...
$mail->setFrom('it.support@ptscu.net', 'anbya');
$mail->addReplyTo('it.support@ptscu.net', 'anbya');

// Menambahkan penerima
include "nahm/koneksi.php";
$id=$_GET['ID'];
...
if(!$mail->send()){
    ...
    echo 'Mailer Error: ' . $mail->ErrorInfo;echo !extension_loaded('openssl')?"Not Available":"Available";
}else{
    echo "<script>alert('berhasil mengirim pesan aktivasi akun member');location='nahm/member.php'</script>";
}