                    ...
                    <form class="form" method="POST" action="verify.php">
                        ...
                        <div class="content">
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" name="input1" class="form-control" placeholder="Email Atau Nomor Telepon..." required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                        ...
                        <button class="btn btn-nahm btn-round btn-lg btn-block" type="submit" name='submit' value="Submit">Login</button>
                        </div>
                        <div class="pull-left">
                            <h6>
                                <a href="daftar.php" class="link">Become a member</a>
                            </h6>
                        </div>
                    </form>
                </div>
