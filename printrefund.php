...
$opnid=intval($opnid1);
$opndate= $hparam['refund_date'];
$opntime= $hparam['refund_time'];
$lastdate= $hparam['refund_date'];
$lasttime= $hparam['refund_time'];
?>
<div><br><br><br></div>
...
?>
<tr valign="top">
<td style="font-size: 4vh;width: 60%;text-align: left;"><b>SERVICE CHARGE <?php echo $hparamx['service_charge'];?>%</b></td>
<td style="font-size: 4vh;width: 40%;text-align: right;"><b><?php echo number_format("$servicecharge");?></b></td>
</tr>
<tr valign="top">
...
<a style="font-size: 5vh;"><b>REFUND Bill</b></a><br>
<a style="font-size: 5vh;"><b>Old Receipt : <?php echo $hparam['bill_number'];?></b></a><br>
<a style="font-size: 5vh;"><b>Old Date : <?php echo $hparam['close_date']." ".$hparam['close_time'];?></b></a><br>
</div>
<div class="separator"></div>
<div class="separator"></div>
