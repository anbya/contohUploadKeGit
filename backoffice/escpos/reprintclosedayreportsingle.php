...
/*sumitemsales*/
$ceknamauser=mysqli_query($koneksi,"SELECT * FROM user where id_user = '$htglterminal[closeuser]'");
...
$printer -> text($separator."\n");
/*sumitemsales*/
$sumitemsales=mysqli_query($koneksi,"SELECT sum(qty) as sumqtyitem, sum(price) as sumpriceitem FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp'");
...
$printer -> text($separator."\n");
/*sumbevsales*/
$sumbevsales=mysqli_query($koneksi,"SELECT sum(qty) as sumbevqty, sum(price) as sumbevprice FROM pos_itemtemp where kdcategory = '191002' AND terminal_id = '$idterminal' AND paidstatus = 'PAID' AND squenceorder != 'tmp'");
...
//bevsls
/*sumfoodsales*/
$sumfoodsales=mysqli_query($koneksi,"SELECT sum(qty) as sumbevqty, sum(price) as sumbevprice FROM pos_itemtemp where kdcategory = '191001' AND terminal_id = '$idterminal' AND paidstatus = 'PAID' AND squenceorder != 'tmp'");
...
//fodsls
/*sumfnbsales*/
$sumfnbsales=mysqli_query($koneksi,"SELECT sum(qty) as sumbevqty, sum(price) as sumbevprice FROM pos_itemtemp WHERE terminal_id = '$idterminal' AND paidstatus = 'PAID' AND squenceorder != 'tmp'");
...
$separator= str_pad("-",42,"-");
$printer -> text($separator."\n");
$loopbvrgs=mysqli_query($koneksi,"SELECT * FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' and kdcategory = '191002' group by kdsubcategory");
...
$sumdetbvgdept=mysqli_query($koneksi,"SELECT sum(qty) as qtydept FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' AND kdsubcategory = '$hdetbvgdept[kdsubcategory]'");
...
$separator= str_pad("-",42,"-");
$printer -> text($separator."\n");
$loopbvrgsdeptitem=mysqli_query($koneksi,"SELECT * FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' and kdsubcategory = '$hdetbvgdept[kdsubcategory]' group by kditem");
...
$sumdetbvgdeptitem=mysqli_query($koneksi,"SELECT sum(qty) as qtydeptitem FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' AND kditem = '$hdetbvgdeptitem[kditem]'");
...
$sumbeverages=mysqli_query($koneksi,"SELECT sum(qty) as qtybeverages FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' and kdcategory = '191002'");
...
$separator= str_pad("-",42,"-");
$printer -> text($separator."\n");
$loopbvrgs=mysqli_query($koneksi,"SELECT * FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' and kdcategory = '191001' group by kdsubcategory");
while($hloopbvrgs = mysqli_fetch_array($loopbvrgs))
{
$detbvgdept=mysqli_query($koneksi,"SELECT * FROM pos_subcategory where kdsubcategory = '$hloopbvrgs[kdsubcategory]'");
$hdetbvgdept = mysqli_fetch_array($detbvgdept);
...
$sumbeverages=mysqli_query($koneksi,"SELECT sum(qty) as qtybeverages FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' and kdcategory = '191001'");
$hsumbeverages= mysqli_fetch_array($sumbeverages);
...
$separator= str_pad("-",42,"-");
$printer -> text($separator."\n");
$loopbvrgs=mysqli_query($koneksi,"SELECT * FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' and kdcategory = '191003' group by kdsubcategory");
while($hloopbvrgs = mysqli_fetch_array($loopbvrgs))
{
$detbvgdept=mysqli_query($koneksi,"SELECT * FROM pos_subcategory where kdsubcategory = '$hloopbvrgs[kdsubcategory]'");
$hdetbvgdept = mysqli_fetch_array($detbvgdept);
...
$sumbeverages=mysqli_query($koneksi,"SELECT sum(qty) as qtybeverages FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' and kdcategory = '191003'");
$hsumbeverages= mysqli_fetch_array($sumbeverages);
...
$sumallplu=mysqli_query($koneksi,"SELECT sum(qty) as qtyallplu FROM pos_itemtemp where terminal_id = '$idterminal' and paidstatus = 'PAID' AND squenceorder != 'tmp' ");
