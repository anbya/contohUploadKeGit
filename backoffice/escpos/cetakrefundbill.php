...
$printer -> text("Lt.GF Unit MGF 6\n");
$printer -> text("021-6684002\n");
...
{
$strpay1=$hparam2['JnsCard'];
$strpay2=number_format($hparam2['Jumlah']);
$headerpay1= str_pad($strpay1,31," ");
$headerpay2= str_pad($strpay2,11," ",STR_PAD_LEFT);
...
$printer -> text("Old Receipt : ".$hparam['bill_number']."\n");
$printer -> text("Old Date : ".$hparam['close_date']."\n");
$separator= str_pad("=",42,"=");
$printer -> text($separator."\n");
$printer -> setJustification(Printer::JUSTIFY_CENTER);
